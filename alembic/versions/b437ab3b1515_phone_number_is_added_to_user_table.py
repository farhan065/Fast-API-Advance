"""phone number is added to user table

Revision ID: b437ab3b1515
Revises: eb4ceea45663
Create Date: 2025-12-19 15:14:24.546616
...
revision: str = 'b437ab3b1515'
down_revision: Union[str, Sequence[str], None] = 'eb4ceea45663'
...
def upgrade() -> None:
    ...
    op.add_column('users_alembic', sa.Column('phone', sa.String(), nullable=True))
